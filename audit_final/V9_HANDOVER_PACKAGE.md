# V9 HANDOVER PACKAGE — ACS SCE Cu-Lignin Manuscript
...
- Class A STRONG_BINDING: 20 (incl. cu2i2_veratrole_methoxyO_startA)
- Class B MODERATE_BINDING: 1
- Class C WEAK_BINDING: 0
- Class D METASTABLE_CONTACT: 3
- Class E NON_BINDING: 14

Total rows: 38 (TIER_A naked-Cu+ adducts + Set B [CuI2]- + Set C Cu2I2 + Set D V2 veratrole).
...
**Class-counts after classifier (38 total rows):**
- A STRONG_BINDING: 20
...
1. Yang et al. 2017, *Nat. Commun.* — CuI thin film / Cu(I) state stability
2. Klochko et al. 2019, *Thin Solid Films* — CuI coatings on textile / aging
3. Nikolic et al. 2020, *Molecules* — Cu(I) / Cu(II) speciation in textile context
4. Coroa et al. 2023 — Cu / lignin / textile binding observations
5. Sun & Chen 2023, *ACS Appl. Nano Mater.* DOI: 10.1021/acsanm.3c01961 — CuI nanostructures / aging
6. Sportelli et al. 2024, *ACS Appl. Eng. Mater.* DOI: 10.1021/acsaenm.4c00548 — XPS / aging-state speciation
...
16. Sangha, A. K.; Petridis, L.; Smith, J. C.; Ziebell, A.; Parks, J. M. *Environ. Prog. Sustain. Energy* **2012**, *31*, 47-54. (DFT modeling of lignin fragments)
17. Petridis, L.; Smith, J. C. *Nat. Rev. Chem.* **2018**, *2*, 382-389. (lignin modeling)

### M.3 CuI textile literature

18. Yang, X.; Liu, X.; Yu, S.; Gan, L.; Zhou, J.; Zeng, Y. *Nat. Commun.* **2017**, *8*, 16076. (CuI thin film conductivity — DOI 10.1038/ncomms16076; verify)
...
22. Sun, X.; Chen, Y. *ACS Appl. Nano Mater.* **2023**, *6*, 11236-11246. DOI: 10.1021/acsanm.3c01961. (CuI nanostructures)
23. Sportelli, M. C.; et al. *ACS Appl. Eng. Mater.* **2024**. DOI: 10.1021/acsaenm.4c00548. (XPS / Cu speciation in coatings)
...
25. Stubbe, J. A.; van der Donk, W. A. *Chem. Rev.* **1998**, *98*, 705-762. (radical / phenoxyl chemistry)
...
### M.5 Oxide-aging literature (six anchors from §I)

28. Yang et al. 2017 (already #18) — re-cited for Cu(I) state stability.
29. Klochko et al. 2019 (already #19) — re-cited for aging-state characterization.
30. Nikolic et al. 2020 (already #20) — re-cited for speciation.
31. Coroa et al. 2023 (already #21) — re-cited.
32. Sun & Chen 2023 (already #22) — re-cited for nanostructure aging.
33. Sportelli et al. 2024 (already #23) — re-cited for XPS oxide signature.
...
| `audit_final/BINDING_SURVIVAL_TABLE.csv` | every (set, ligand, mode) row with classifier verdict, contact distance, fragmentation flag, BE_gas, BE_smd, n_imag (38 rows after extension by V9 build) | §H |
...
| `audit_final/BINDING_SURVIVAL_TABLE_setD_alt_v2.csv` | Set D V2-specific survival/classifier rows (subset/extension of the canonical 38-row table) | §H, §F.1 |
